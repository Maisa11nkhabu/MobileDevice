      ...
      >
        <View style={styles.logoContainer}>
          ...
          <Text style={[styles.subtitle, { color: colors.muted }]}>
            Welcome To Limkokwing University Of Creative Technolgy
          </Text>
        ...
        {faculties.map((faculty) => (
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("Courses", { facultyName: faculty.name })
            }
          >
            <View style={styles.row}>
              <View style={[styles.iconBubble, { backgroundColor: "lavender" }]}>
                <FontAwesome5 name={faculty.icon} size={18} solid color={colors.accent} />
              </View>
              <Text style={[styles.text, { color: colors.text }]} numberOfLines={2}>
                {faculty.name}
              </Text>
              <FontAwesome5 name="chevron-right" size={16} solid color={colors.muted} />
            </View>
          </TouchableOpacity>
        ))}
      </ScrollView>
